          ...
          <div className="flex justify-end mb-4">
            <div className="bg-gray-100 rounded-lg p-1 flex gap-1">
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${viewType === 'upcoming'
              ...
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${viewType === 'all'
                    ? 'bg-blue-600 text-white shadow-md'
                    : 'text-gray-600 hover:text-gray-900'
                  }`}
              >
