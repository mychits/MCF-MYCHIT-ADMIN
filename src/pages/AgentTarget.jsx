...
const AgentTarget = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Fetching only Agents
        const agentRes = await api.get("/agent/get-agent");
  ...
  useEffect(() => {
    ...
    const fetchTargets = async () => {
      try {
        ...
        // Fetching Agent Targets
        const res = await api.get("/target/agents", {
          params: {
            from_date,
            to_date,
          },
      ...
      <div className="flex mt-20">
        ...
        <div className="flex-grow p-6">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-semibold">Agent Targets Management</h1>
            <button
